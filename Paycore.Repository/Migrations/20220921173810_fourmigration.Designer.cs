...
namespace Paycore.Repository.Migrations
{
    ...
    [Migration("20220921173810_fourmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayCore.Core.Models.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PayCore.Core.Models.UserRefreshToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PayCore.Core.Models.UserApp", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PayCore.Core.Models.Offer", b =>
                {
                    ...
                    b.HasOne("PayCore.Core.Models.UserApp", "UserApp")
                        .WithMany("Offers")
            ...
            modelBuilder.Entity("PayCore.Core.Models.Product", b =>
                {
                    b.HasOne("PayCore.Core.Models.Category", "Category")
                        .WithMany("Products")
